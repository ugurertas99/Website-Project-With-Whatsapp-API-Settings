<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Ornek4.Default" %>
...
<body>
    ...
    <header class="header">
        ...
        <a href="#" class="logo">Nock Nock Coffee <i class="fas fa-mug-hot"></i></a>
        ...
        <nav class="navbar">
            ...
            <a href="#book">rezervasyon</a>
        </nav>

        <a href="#" class="btn">masa ayır</a>
    </header>
    ...
    <section class="home" id="home">
        <div class="row">
            <div class="content">
                <h3>sabahları taze kahve</h3>
                <a href="#" class="btn">bi tane al</a>
            </div>
    ...
    <section class="about" id="about">
        <h1 class="heading">hakkında <span>niye biz</span></h1>
        ...
        <div class="row">
            ...
            <div class="content">
                <h3 class="title">bizi özel yapan ne </h3>
                <p>
                    biz kahvenin neyini iyi yaptığını biliyoruz. en iyi çekirdeği en özel müşterimize sunuyoruz. kahveyi samimiyetle birleştiriyoruz
                </p>
                <a href="#" class="btn">oku</a>
                <div class="icons-container">
                    <div class="icons">
                        <img src="image/about-icon-1.png" alt="">
                        <h3>kahve kalitesi</h3>
                    </div>
                    <div class="icons">
    ...
    <section class="menu" id="menu">
        <h1 class="heading">menümüz <span>en popüler menü</span></h1>
    ...
    <section class="book" id="book">
        ...
        <form action="" runat="server">            
            ...
            <asp:TextBox ID="txtEmail" runat="server" CssClass="box"></asp:TextBox>            
            <asp:TextBox ID="txtNumber" runat="server" CssClass="box"></asp:TextBox>           
            <asp:TextBox ID="txtMesaj" runat="server" CssClass="box" TextMode="MultiLine" Height="250"></asp:TextBox>
            <asp:Button ID="btnSendMessage" runat="server" Text="Mesaj Gönder" CssClass="btn"/>
        </form>
    </section>
    ...
    <section class="footer">
        <div class="box-container">
            ...
            <div class="box">
                <h3>contact info</h3>
                <a href="https://api.whatsapp.com/send?phone=5530376161"><i class="fas fa-phone"></i> whatsapp</a>
